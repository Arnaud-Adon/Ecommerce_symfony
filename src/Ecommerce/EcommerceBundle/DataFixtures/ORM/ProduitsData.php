...
class ProduitsData extends AbstractFixture implements OrderedFixtureInterface {
   public function load(ObjectManager $manager){
       ...
       $produit1->setDescription('Le poivron rouge est un groupe de cultivars de l\'espèce Capsicum annum');
       ...
       $produit2->setDescription('Le piment est généralement associé à la saveur du piquent');
       ...
       $produit4->setDescription('Le poivron vert est un groupe de culivars de l\'espèce Capsium annum');
       ...
       $produit5->setDescription('Le raisin est le fruit de la Vigne. Le raisin de la vigne cultivée Vitis vinifera est un des fruits les plus cultivés au monde');
