...
class ProduitsAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceBundle:Admin:produits/layout/index.html.twig', array(
            'produits' => $produits,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EcommerceBundle:Admin:produits/layout/new.html.twig', array(
            'produit' => $produit,
    ...
    public function showAction(Produits $produit)
    {
        ...
        return $this->render('EcommerceBundle:Admin:produits/layout/show.html.twig', array(
            'produit' => $produit,
    ...
    public function editAction(Request $request, Produits $produit)
    {
        ...
        return $this->render('EcommerceBundle:Admin:produits/layout/edit.html.twig', array(
            'produit' => $produit,
