...
class CategoriesAdminController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('EcommerceBundle:Admin:categories/layout/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('EcommerceBundle:Admin:categories/layout/new.html.twig', array(
            'category' => $category,
    ...
    public function showAction(Categories $category)
    {
        ...
        return $this->render('EcommerceBundle:Admin:categories/layout/show.html.twig', array(
            'category' => $category,
    ...
    public function editAction(Request $request, Categories $category)
    {
        ...
        return $this->render('EcommerceBundle:Admin:categories/layout/edit.html.twig', array(
            'category' => $category,
